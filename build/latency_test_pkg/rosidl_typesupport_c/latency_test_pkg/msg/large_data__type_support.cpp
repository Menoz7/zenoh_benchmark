...
static const _LargeData_type_support_symbol_names_t _LargeData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, latency_test_pkg, msg, LargeData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, latency_test_pkg, msg, LargeData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, latency_test_pkg, msg, LargeData)() {
  return &::latency_test_pkg::msg::rosidl_typesupport_c::LargeData_message_type_support_handle;
}
